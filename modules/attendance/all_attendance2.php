            ...
            <div class="card border-0 bg-light h-100">
                <div class="card-body">
                    ...
                    <div class="row g-2 mt-2">
                        ${data.att?.check_in_photo
                            ? `<div class="col-6 text-center">
                                <div class="small text-muted mb-1">📸 Ảnh vào</div>
                                <img src="${data.att.check_in_photo}" class="img-fluid rounded" style="max-height:180px; border:2px solid #28a745;">
                               </div>`
                            : `<div class="col-6 text-center text-muted small d-flex align-items-center justify-content-center" style="height:100px; background:#f8f9fa; border-radius:8px;">Không có ảnh vào</div>`}
                        ${data.att?.check_out_photo
                            ? `<div class="col-6 text-center">
                                <div class="small text-muted mb-1">📸 Ảnh ra</div>
                                <img src="${data.att.check_out_photo}" class="img-fluid rounded" style="max-height:180px; border:2px solid #dc3545;">
                               </div>`
                            : `<div class="col-6 text-center text-muted small d-flex align-items-center justify-content-center" style="height:100px; background:#f8f9fa; border-radius:8px;">Không có ảnh ra</div>`}
                    </div>
                </div>
            </div>
        </div>`;
